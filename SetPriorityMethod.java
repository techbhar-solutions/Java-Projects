import java.util.Scanner;
  ...
  class loginthread extends Thread{
    static Scanner sc = new Scanner(System.in);
       ...
       boolean found = false;
      loginthread() {
          setName("Login-Thread");           // 👈 set thread name
        ...
        public  void run(){
            ...
            if(found){
                ...
                quizthread.start();
                quizthread.join();  // Login thread waits until quiz finishes
...
class quiz extends Thread{
    ...
    static String [] q10_option = {"Maharaja Ranjit Singh","Maharaja Duleep Singh","Maharaja Narinder Singh"," Maharaja Sher Singh"};
              quiz() {
              setName("Quiz-Thread");             // 👈 set name
              setPriority(NORM_PRIORITY);         // 👈 normal priority
              }
          @Override
          public  void run() {
              try {
